...
class Mysql{
    ...
    */
    ...
    public function __construct(){
        ...
        $this->conn=mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_DATABASE, DB_PORT) or die("Failed to connect to MySQL: ");
        mysqli_select_db($this->conn, DB_DATABASE) or die('Database selection error');
